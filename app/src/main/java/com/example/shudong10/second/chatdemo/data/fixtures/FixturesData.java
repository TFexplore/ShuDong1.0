...
abstract class FixturesData {
    ...
    static ArrayList<String> avatars = new ArrayList<String>() {
        {
            add(new String(String.valueOf(R.drawable.jingling)));
            add(new String(String.valueOf(R.drawable.mask)));
            add(new String(String.valueOf(R.drawable.mask_active)));
            add(new String(String.valueOf(R.drawable.fk)));
        }
    };
    ...
    static String getRandomMessage() {//随机从集合取走一个消息
